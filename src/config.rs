...
fn get_default_cps() -> Option<usize> {
    Some(1)
}
fn get_default_url() -> String {
    "https://10.199.28.159".to_string()
}
fn get_default_max_connections() -> Option<u32> {
    None
}
fn get_default_max_time() -> Option<u32> {
    None
}
